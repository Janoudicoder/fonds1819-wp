...
if ($volgorde == 'tekst - afbeelding') {
    ...
    $contentRechts = '<div class="img-wrapper w-full relative overflow-hidden">';
    ...
    $contentLinksClass = "relative flex flex-col items-start w-full  h-full order-2 lg:order-1 lg:justify-center lg: max-w-[653px]  lg:mx-auto";
...
elseif ($volgorde == 'afbeelding - tekst') {
    ...
    . $blocktitle . '</div>' 
    . '<div class="img-wrapper w-full relative overflow-hidden">'
    . wp_get_attachment_image($afbeelding['id'], 'full', "", array("class" => "w-full h-auto object-cover")) 
    . '<div class="svg-overlay absolute inset-0 w-full h-full pointer-events-none">'; // SVG container over the image
    ...
    $contentRechtsClass = "relative flex flex-col items-start w-full  h-full lg:justify-center lg:max-w-[653px]";
...
if ($tekst): 
?>
<section class="tekst-afbeelding pt-24 <?php echo ($volgorde == 'afbeelding - tekst') ? 'bg-[#FFFFF0] pb-12' : 'my-0'; ?> md:my-0">
